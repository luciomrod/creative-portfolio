    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 via-zinc-900 to-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-40 right-10 w-72 h-72 bg-slate-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Link href="mailto:luciomedinawork@gmail.com">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/50 hover:bg-zinc-800 text-zinc-400 hover:text-white"
            ...
            <div className="space-y-6">
              <GlassmorphicCard>
                <p className="text-lg text-zinc-300">
                  I'm a Frontend Developer with expertise in building dynamic and optimized user interfaces, leveraging React, Next.js, and TypeScript. Focused on performance, accessibility, and best practices, with the ability to work in agile teams and deliver scalable, efficient solutions.
                </p>
                <p className="text-lg text-zinc-300 mt-4">
                  My journey in tech started with a strong foundation in Javascript and React. I've worked with various
                  teams to create intuitive, performant, and accessible digital experiences.
                </p>
                <p className="text-lg text-zinc-300 mt-4">
                  When I'm not coding, you can find me exploring new technologies, making music, and staying up-to-date with the latest industry trends.
                </p>

                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    <div className="text-sm text-zinc-500">Name</div>
                    <div className="font-medium">Lucio Andrés Medina Rodriguez</div>
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">Córdoba, Argentina, 5000.</div>
                  </div>
                  <div className="space-y-1">
                ...
                <div className="mt-8">
                  <Link 
                    href="/cv/Lucio-summary-2025.pdf" 
                    download="Lucio-Medina-Resume.pdf"
                    target="_blank"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">linkedin.com/in/lucioandresmr/</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="font-medium">github.com/luciomrod</div>
                  </div>
                </div>
              </div>
        ...
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <Link href="/" className="font-bold text-xl">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-500">Lucio</span>
              <span className="text-white">Andres</span>
            </Link>
            <p className="text-sm text-zinc-500 mt-2">
              © {new Date().getFullYear()} Lucio Andrés Medina Rodriguez. All rights reserved.
            </p>
          </div>
