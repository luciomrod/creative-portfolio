        ...
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          ...
          {isMobile ? (
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-cyan-600 hover:to-blue-500 border-0"
                asChild
              >
                <Link href="/cv/Lucio-summary-2025.pdf" target="_blank" rel="noopener noreferrer">
                  Resume
                </Link>
              </Button>
            </div>
